...
# %%
# 保存模型 （可跳过）
torch.save(net, base_dir + '/models/logistic_regression/lr_2_1.pt')

# %%
# 载入模型（可跳过）
net = torch.load(base_dir + '/models/logistic_regression/lr_2_1.pt')
net.eval()
...
# %%
# 保存
y_df.to_csv(base_dir + '/models/logistic_regression/output_2_1_2.csv', index=False)
