...
# %%
base_dir = os.getcwd()
x_df = pd.read_csv(base_dir + '/dataset/dataset4/trainset/train_main_part.csv')
y_df = pd.read_csv(base_dir + '/dataset/dataset4/trainset/train_label_part.csv')
...
# output:
# best n_estimators: 4
# best cv score: 0.5059289706721908
